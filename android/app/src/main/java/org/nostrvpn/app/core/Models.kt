...
data class AppState(
    ...
    val dnsOverrideActive: Boolean = false,
...
fun parseAppState(jsonText: String): AppState {
    ...
    return AppState(
        ...
        networkDnsServers = json.optJSONArray("networkDnsServers").toStringList(),
        dnsOverrideActive = json.optBoolean("dnsOverrideActive"),
